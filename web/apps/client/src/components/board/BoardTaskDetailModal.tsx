...
const chip = css`border:1px solid var(--border-soft); border-radius:.45rem; padding:.2rem .45rem; background:var(--palette-rgba-255-255-255-035-b36273); color:var(--text-soft); font-size:.72rem;`;
const projectChip = css`${chip} border-color:var(--palette-rgba-196-69-255-28-be5f7e); color:var(--palette-hex-efc4ff-6ae75a);`;
const labelChip = css`${chip} border-color:var(--palette-rgba-84-95-168-32-eee076); color:var(--palette-hex-e0d8ff-07fbaf);`;
const muted = css`margin:0; color:var(--text-dim); font-size:.78rem; line-height:1.45;`;
const warning = css`margin:0; border:1px solid var(--palette-rgba-255-177-59-25-569cf6); border-radius:.65rem; padding:.6rem .7rem; background:var(--palette-rgba-255-138-0-08-69f65a); color:var(--palette-hex-ffd4a1-b83647); font-size:.78rem;`;
const messageStack = css`display:grid; gap:.45rem;`;
const scheduleCard = css`display:grid; gap:.35rem; border-left:3px solid var(--accent); padding:.65rem .75rem; background:var(--palette-rgba-255-255-255-025-40fa64); color:var(--text-soft); font-size:.78rem; & p{margin:0;} & summary{cursor:pointer; color:var(--text-main);}`;
...
const textarea = css`width:100%; resize:vertical; border:1px solid var(--border-strong); border-radius:.65rem; padding:.7rem; background:var(--palette-rgba-255-255-255-035-b36273); color:var(--text-main); outline:none; &:focus-visible{border-color:var(--accent); outline:2px solid var(--palette-hex-00e0ff-93d32f); outline-offset:2px;}`;
