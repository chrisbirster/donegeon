...
const navButton = css`display:flex; align-items:center; justify-content:space-between; gap:.5rem; width:100%; border:1px solid transparent; border-radius:.65rem; padding:.58rem .65rem; background:var(--palette-rgba-255-255-255-015-211235); color:var(--text-main); font-size:.88rem; text-align:left; &:hover{border-color:var(--border-soft); background:var(--palette-rgba-255-255-255-045-53fc29);}`;
const navButtonActive = css`border-color:var(--palette-rgba-196-69-255-34-3a2502); background:var(--accent-wash); color:var(--accent-text);`;
...
const smallManagerButton = css`border:1px solid transparent; border-radius:.5rem; padding:.35rem .55rem; background:transparent; color:var(--accent-text); font-size:.72rem; &:hover{border-color:var(--border-soft); background:var(--palette-rgba-255-255-255-035-b36273);}`;
...
const projectButton = css`display:flex; align-items:center; justify-content:space-between; gap:.6rem; min-width:0; width:100%; border:1px solid var(--border-soft); border-radius:.75rem; padding:.68rem .75rem; background:var(--palette-rgba-255-255-255-018-d34853); color:var(--text-main); text-align:left; &:hover{border-color:var(--border-hover); background:var(--palette-rgba-255-255-255-045-53fc29);}`;
const projectButtonActive = css`border-color:var(--palette-rgba-196-69-255-4-af19a3); background:var(--accent-wash);`;
const teamBoardButton = css`border-color:var(--palette-rgba-218-67-255-45-9c32e6); background:linear-gradient(110deg,var(--palette-rgba-82-22-112-52-6216a8),var(--palette-rgba-255-32-114-08-dd7e73)); box-shadow:inset 0 0 22px var(--palette-rgba-196-69-255-07-186de9),0 0 18px var(--palette-rgba-196-69-255-06-92c9d1);`;
...
const teamBoardChip = css`flex:0 0 auto; border:1px solid var(--palette-rgba-218-67-255-38-a662c5); border-radius:999px; padding:.12rem .4rem; background:var(--palette-rgba-196-69-255-12-d30007); color:var(--palette-hex-f1c8ff-fbce07); font-size:.62rem; font-weight:700; letter-spacing:.08em; text-transform:uppercase; white-space:nowrap;`;
const favoriteGlyph = css`color:var(--palette-hex-ffd4a1-b83647);`;
const favoriteButton = css`border:1px solid var(--border-strong); border-radius:.7rem; background:var(--panel-soft); color:var(--text-dim); &:hover{border-color:var(--border-hover); color:var(--palette-hex-ffd4a1-b83647);}`;
const favoriteButtonActive = css`color:var(--palette-hex-ffd4a1-b83647); border-color:var(--palette-rgba-255-212-161-32-cf0a34);`;
...
const dialogInput = css`width:100%; border:1px solid var(--border-strong); border-radius:.65rem; padding:.68rem .75rem; background:var(--palette-rgba-255-255-255-035-b36273); color:var(--text-main); outline:none; &:focus-visible{border-color:var(--accent); outline:2px solid var(--palette-hex-00e0ff-93d32f); outline-offset:2px;}`;
