...
overflow-y: auto;
background-color: color-mix(in srgb, var(--palette-hex-000-598b32) 60%, transparent);
...
--tw-shadow: 0 30px 100px var(--tw-shadow-color, var(--palette-rgba-0-0-0-0-55-a71fe6));
...
border-style: var(--tw-border-style);
  border-width: 1px;
border-color: var(--border-strong);
background-color: var(--palette-rgba-255-255-255-0-03-74b767);
padding-inline: calc(var(--spacing) * 3);
